...
import thiGK.ntu64132072.HoTanTai_BaiThiGK_Lan2.models.Student;
...
public class StudentController {
    ...
    public StudentController() {
        students.add(new Student("SV001", "A", "G001"));
        students.add(new Student("SV002", "B", "G002"));
        students.add(new Student("SV003", "C", "G001"));
        students.add(new Student("SV004", "D", "G003"));
        students.add(new Student("SV005", "E", "G002"));
    }
